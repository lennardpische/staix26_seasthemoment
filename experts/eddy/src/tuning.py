...
import numpy as np
# optuna is only needed for the offline hyperparameter search, not for prediction
# (predict.py imports return_covs_and_target from here). Import lazily so the
# prediction path doesn't require optuna to be installed.
try:
    import optuna
